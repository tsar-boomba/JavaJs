...
public class JSArray<E extends Object>
	...
	@SuppressWarnings("unchecked")
	@FunctionalInterface
	public static interface TwoArgMapFunction<E, T extends Object>
		extends BaseMapFunction<E, T> {
	...
	@FunctionalInterface
	public static interface TwoArgFilterFunction<E>
		extends BaseFilterFunction<E> {
	...
	@FunctionalInterface
	public static interface ThreeArgFilterFunction<E>
		extends TwoArgFilterFunction<E> {
	...
	public JSArray<E> filter(ThreeArgFilterFunction<E> predicate) {
		...
		JSArray<E> filtered = new JSArray<>();
		for (int i = 0; i < this.size; i++) if (
			predicate.filter(this.get(i), i, this)
		) filtered.add(this.get(i));
		return filtered;
	}
	...
	public static interface TwoArgForEachFunction<E>
		extends BaseForEachFunction<E> {
	...
	public static interface ThreeArgForEachFunction<E>
		extends TwoArgForEachFunction<E> {
	...
	public static interface ThreeArgEveryFunction<E>
		extends TwoArgEveryFunction<E> {
	...
	public static interface ThreeArgSomeFunction<E>
		extends TwoArgSomeFunction<E> {
		public boolean accept(E t, int i, JSArray<E> arr);
